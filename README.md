...
AUTH_DEFAULT_SYSADMIN_PASSWORD=replace_with_a_unique_password_of_12_or_more_characters
AUTH_DEFAULT_PROFESSOR_PASSWORD=replace_with_a_different_password_of_12_or_more_characters
NEXT_PUBLIC_APP_URL=http://localhost:3000
```

The two bootstrap passwords are required only when the database must create or
repair its default administrator accounts. Keep their real values in
