...
export default function ExamPage() {
  ...
  return (
    <>
      ...
      {/* WARNING OVERLAY */}
      <div id="warning-overlay" style={{ display: 'none' }} role="alertdialog" aria-modal="true" aria-labelledby="warning-overlay-title" aria-describedby="warning-overlay-msg warning-overlay-sub">
        <div className="warning-overlay-content" id="warning-overlay-content">
          ...
          <div className="warning-pips" id="warning-pips">
            <div className="warning-pip" id="wpip-1" />
            <div className="warning-pip" id="wpip-2" />
            <div className="warning-pip" id="wpip-3" />
          </div>
          <div className="warning-overlay-count-row" id="warning-overlay-count-row">
        ...
        <div className="student-portal" id="student-portal">
          ...
          <div className="portal-main" id="portal-main">
            ...
            <div className="portal-content">
              ...
              <div id="portal-tab-archived" className="hidden">
                <div className="dash-section-label" style={{ marginBottom: '18px' }}>Archived Courses</div>
                <div id="archived-subjects-list" />
              </div>
      ...
      <div id="state-entry" className="state-center hidden">
        <div className="state-card">
          ...
          <h2>Enter Exam</h2>
          <p>Enter your Student ID and the exam access code provided by your instructor.</p>
      ...
      <div id="camera-container" className="camera-container" style={{ display: 'none' }}>
        <div id="camera-drag-surface" className="camera-feed-wrap">
          ...
          <span id="yolo-camera-status" className="yolo-camera-status" data-state="disabled" style={{ display: 'none' }} aria-hidden="true" />
      ...
      <div id="face-positioning-warning" className="face-positioning-warning" style={{ display: 'none' }} role="status" aria-live="polite" aria-atomic="true" />
